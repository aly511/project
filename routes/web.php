...
// Route::get('admin/home', 'adminControler@show')->name('adminhome');
// Route::get('admin/insert_page', 'adminControler@insert_page')->name('insert_page');
// Route::post('admin/add/save','adminControler@add')->name('add_prod');
